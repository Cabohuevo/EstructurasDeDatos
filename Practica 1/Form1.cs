...
public partial class Form1 : Form
{
    ...
    //Validaciones, ningun campo puede ser menor que 0
    ...
    //Validaciones, para el triangulo se verifica que cumpla con ciertos parametros para 
    //comprobar que coinciden con un tipo de triangulo (todos los lados iguales,2 lados iguales y lados desiguales )
    ...
    {
        // Obtener el radio desde el control numérico
        ...
        //Mostrar en las etiquetas correspondientes los resultados
    ...
    {
        // Obtener la base y la altura desde los controles numericos
    ...
    private void BtnTCalcular_Click(object sender, EventArgs e)
    {
            ...
            // Obtener los valores de los lados desde los controles numéricos
            ...
            // Mostrar el tipo de triangulo en LblTTipo
    ...
    {
        // Obtener el valor del lado desde el control numérico
